...
<br>
<img src="aa.png" alt="plot" style="height: 400px; max-width: 88%">
<img src="ab.png" alt="plot" style="height: 400px; max-width: 88%">

The above is with LCD but the below is the code in which I use the serial plotter!
<br>>
<img src="ac.png" alt="plot" style="height: 400px; max-width: 88%">
